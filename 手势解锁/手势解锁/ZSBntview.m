...
//
    ...
    for (NSInteger i=0; i < self.bntarry.count; i++) {
        ...
        newpwd=[NSString stringWithFormat:@"%ld",(long)Bntcen.tag];
        
    }
            NSLog(@"%@-----------",newpwd);
//        
//        //判断存的密码里面有没有刚才的点击密码
//        if([_pwdstr rangeOfString:newpwd].location !=NSNotFound)//_roaldSearchText
//        {
//            NSLog(@"yes");
//        }
//        else
//        {
//            NSLog(@"no");
//            _pwdstr=[NSString stringWithFormat:@"%@%@",_pwdstr,newpwd];
//            
//            
//        }
//      
